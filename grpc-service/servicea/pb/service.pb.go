...
func init() {
	proto.RegisterType((*SayHelloRequest)(nil), "svcA.SayHelloRequest")
	proto.RegisterType((*SayHelloResponse)(nil), "svcA.SayHelloResponse")
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0xcb, 0x4c, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x29, 0x2e, 0x4b, 0x76, 0x54,
	...
	0xb8, 0x58, 0x8a, 0x52, 0x8b, 0x0b, 0xa0, 0xca, 0xc0, 0x6c, 0x23, 0x77, 0x2e, 0x8e, 0xc4, 0x60,
	...
	0xff, 0xff, 0x67, 0x9f, 0xe6, 0xaa, 0xc1, 0x00, 0x00, 0x00,
}
...
func NewAServiceClient(cc *grpc.ClientConn) AServiceClient {
	return &aServiceClient{cc}
}

func (c *aServiceClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	out := new(SayHelloResponse)
	err := c.cc.Invoke(ctx, "/svcA.aService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedAServiceServer) SayHello(ctx context.Context, req *SayHelloRequest) (*SayHelloResponse, error) {
...
func _AService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SayHelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AServiceServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svcA.aService/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AServiceServer).SayHello(ctx, req.(*SayHelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _AService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "svcA.aService",
	HandlerType: (*AServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _AService_SayHello_Handler,
		},
	},
